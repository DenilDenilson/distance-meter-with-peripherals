 ...
 * Author: jorda
 *
 * Created on 25 de enero de 2023, 05:12 PM
 */

#ifndef CONFIG_DEVICE_H
#define	CONFIG_DEVICE_H

// Zona para la configuración de fusibles (bits de configuración para el MCU)
...
#define _XTAL_FREQ 16000000UL //U significa sin signo y L largo


// Incluimos librerías
#include <xc.h> // Librería obligatoria para configurar
#include <pic18f45k50.h> // Librería que contiene los registros del MCU
#include <stdint.h> // Librería ANSI C -> Define los tipos de datos enteros
#include <stdio.h>
