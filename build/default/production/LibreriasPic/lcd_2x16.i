...
# 2 "<built-in>" 2
# 1 "LibreriasPic/lcd_2x16.c" 2

# 1 "LibreriasPic/lcd_2x16.h" 1




# 1 "LibreriasPic/config_device.h" 1
# 18 "LibreriasPic/config_device.h"
...
# 92 "LibreriasPic/config_device.h"
...
# 92 "LibreriasPic/config_device.h" 2
...
# 95 "LibreriasPic/config_device.h" 2
...
# 96 "LibreriasPic/config_device.h" 2



void OSCILADOR_Init(void);
# 5 "LibreriasPic/lcd_2x16.h" 2
# 30 "LibreriasPic/lcd_2x16.h"
...
void Lcd_Cmd(unsigned char a)
{
 ...
 Lcd_Port(a);
 LATD |= (1<<3);
    _delay((unsigned long)((4)*(16000000UL/4000.0)));
 LATD &= ~(1<<3);
}
...
void Lcd_Init( void )
{
 ...
 Lcd_Cmd(0x03);
 _delay((unsigned long)((11)*(16000000UL/4000.0)));
 Lcd_Cmd(0x03);
...
void Lcd_Write_Char(unsigned char a)
{
   ...
   Lcd_Port(y>>4);
   LATD |= (1<<3);
   _delay((unsigned long)((40)*(16000000UL/4000000.0)));
   LATD &= ~(1<<3);
   Lcd_Port(temp);
   LATD |= (1<<3);
   _delay((unsigned long)((40)*(16000000UL/4000000.0)));
